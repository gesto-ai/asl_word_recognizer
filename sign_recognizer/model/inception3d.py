...
class InceptionI3d(nn.Module):
    ...
    def forward(
        ...
        if pretrained:
            ...
            freeze_endpoints: List[str] = self.VALID_ENDPOINTS[:-n_tune_layers]
            tune_endpoints: List[str] = self.VALID_ENDPOINTS[-n_tune_layers:]
        else:
            freeze_endpoints: List[str] = []
            tune_endpoints: List[str] = self.VALID_ENDPOINTS
